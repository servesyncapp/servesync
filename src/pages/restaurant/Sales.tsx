export default function Sales() {
  return (
    <div>
      <h1 className="text-2xl font-bold text-[--color-text-primary] mb-1">Sales Reports</h1>
      <p className="text-sm text-[--color-text-secondary] mb-6">
        Log daily units sold for promoted items
      </p>
      ...
      <div className="card overflow-hidden">
        ...
        <div className="relative h-52 bg-[--color-surface-2] flex items-center justify-center border-b border-[--color-border]">
          ...
          <div className="relative z-10 text-center px-6">
            ...
            <p className="text-lg font-bold text-[--color-text-primary] mb-1">Manual Sales Reporting</p>
            <p className="text-sm text-[--color-text-secondary] max-w-xs mx-auto">
              Log daily units sold for each promoted item and track revenue influenced by ServeSync.
            </p>
          </div>
        </div>

        {/* Preview list of planned features */}
        <div className="px-5 py-4 grid grid-cols-2 gap-3">
          {[
            'Daily units sold entry',
            'Revenue per item',
            'Promoted vs baseline',
